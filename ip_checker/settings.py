"""
Django settings for ip_checker project.
...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', '10.0.0.40']

CSRF_TRUSTED_ORIGINS = ['https://localhost', 'https://10.0.0.40', 'https://127.0.0.1', 'https://localhost:32444', 'https://10.0.0.40:32444', 'https://127.0.0.1:32444']
...
WSGI_APPLICATION = 'ip_checker.wsgi.application'
